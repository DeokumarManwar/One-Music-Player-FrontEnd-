    ...
    >
      <div className="w-full flex justify-center items-center gap-20">
        <NavLink
          ...
          className="flex items-center justify-center px-4 py-3 bg-blue-600 text-white hover:text-black   border rounded-md border-white hover:border-black hover:shadow-md cursor-pointer"
        >
          Add Songs
        </NavLink>
        {songFilter && (
